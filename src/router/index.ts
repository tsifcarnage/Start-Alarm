...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'avantages', name: 'avantages', component: () => import('../views/AvantagesView.vue') },
      { path: 'produits', name: 'produits', component: () => import('../views/ProductView.vue') },
      { path: 'carte', name: 'carte', component: () => import('../views/CarteView.vue') },
      { path: 'contact', name: 'contact', component: () => import('../views/ContactView.vue') },
    ]
  },
  { path: '/:pathMatch(.*)*', name: 'page-non-trouvée', component: () => import('../views/NotFoundView.vue') }
]
